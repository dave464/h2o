...
<div class="modal" id="myModal">
  ...
  <!--<a class = "btn btn-primary"  id ="addBtn" href="add_badge.php" > Add Data</a> </div>-->
    <br>
...
<table id="table" class="table"style="margin-left:15px; width:97%; margin-top:60px;border:1px solid blue;" >
  <thead>
    <tr>
      ...
      <th scope="col" class=" border-primary" style="background:#1E90FF;color:white;">STAT</th>
  ...
  <?php  
    ...
    <tr>
      <td scope="row" class="border-primary"><?php echo $fetch['badge_id']?></th>
