    ...
    <body style="background-color: #fff" >
      ...
      <div class="container">
        <?php
            ...
            merchant.business_name,merchant.merchant_id, merchant.owner, merchant.address , merchant.barangay, customer.firstname, customer.lastname, customer.address, customer.contact_number,customer.customer_id,deliveryman.name, deliveryman.plate_number, deliveryman.contact_number, deliveryman.deliveryman_id,deliveryman.vaccination_status
            FROM `orderlist`
