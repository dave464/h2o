...
<section >
  ...
  <div>
    <button type="button" class="btn btn-primary" onclick="window.location='purchase.php'" style="background-color: white; border:red; color:black; margin-left:-1px; width:100px;">
     ...
     <button type="button" class="btn btn-primary" onclick="window.location='received_orders.php'" style="background: rgb(0,115,174);background: linear-gradient(90deg, rgba(0,115,174,1) 0%, rgba(3,169,244,1) 80%);color:black; margin-left:240px; margin-top:-88px;width:100px;">
