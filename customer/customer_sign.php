...
<div id="bg"></div>
 <form action="customer_signup-check.php" method="POST" enctype="multipart/form-data" >
...
<center><h2>Registration</h2>      </center>
            ...
            <tr>
              ...
              First Name:
                ...
                <td>
              <input type="text" name="firstname"  class="email"  required = "required">
              </td>
              </tr>
            ...
            <tr>
              ...
              Last Name:
                ...
                <td>
              <input type="text" name="lastname"  class="email"  required = "required">
              </td>
              </tr>
